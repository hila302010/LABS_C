...
/*
decription: set the signature file name
input: none
output: none
*/
void SetSigFileName() {
...
/*
decription: print the virus information
input: virus* v, FILE* file
output: none
*/
void printVirus(virus* v, FILE *file) {
...
/*
decription: read the virus information from the file
input: FILE* file
output: virus*
*/
virus* readVirus(FILE* file) {
...
/*
decription: load the virus signatures from the file
input: link ** virus_list
output: none
*/
void loadSignatures(link ** virus_list) {
...
/*
decription: check the magic number of the file
input: FILE* file
output: none
*/
void checkMagicNumber(FILE* file) {
...
/*
decription: print the virus information from the list
input: link* virus_list, FILE* file
output: none
*/
void list_print(link* virus_list, FILE* file) {
...
/*
decription: append the virus to the list
input: link* virus_list, virus* data
output: link*
*/
link* list_append(link* virus_list, virus* data) {
...
/*
decription: detect the virus in the buffer
input: char *buffer, unsigned int size, link *virus_list
output: none
*/
void detect_virus(char *buffer, unsigned int size, link *virus_list)
{
...
/*
decription: detect the viruses in the file
input: link *virus_list, const char *filename
output: none
*/
void detectViruses(link *virus_list, const char *filename) {
...
/*
decription: neutralize the virus in the file
input: char *fileName, int signatureOffset
output: none
*/
void neutralize_virus(char *fileName, int signatureOffset) {
...
/*
decription: fix the file by neutralizing the detected viruses
input: char *fileName, link *virusList
output: none
*/
void fixFile(char *fileName, link *virusList) {
